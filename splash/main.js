...
function preload()
{
	...
	game.load.atlas('timon', 'assets/data/timon.png', 'assets/data/timon.json');
...
function create()
{
	...
	var timon = game.add.sprite(game.world.centerX, 350, 'timon');
	timon.anchor.setTo(0.5, 1);
	timon.animations.add('show');
	timon.animations.play('show', 12, true);
